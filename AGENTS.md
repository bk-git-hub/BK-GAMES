...
## 8. Screenshot Notion 업로드 규칙

사용자가 스크린샷을 요청하면, 생성하거나 캡처한 스크린샷을 사용자에게 보여주는 것과 함께 지정된 Notion Screenshots 페이지에도 업로드한다.

대상 Notion 페이지:

```text
https://app.notion.com/p/bk-99/Screenshots-377793efb8018067b688c2624754e965
```

업로드할 때는 다음 정보를 함께 남긴다.
...
Notion connector 권한이 없거나 업로드에 실패하면, 실패 이유를 보고하고 로컬 스크린샷 경로 또는 확인 가능한 대체 링크를 제공한다.

스크린샷 파일은 사용자가 명시적으로 요청하지 않는 한 커밋하지 않는다.
